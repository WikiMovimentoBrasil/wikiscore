...
if ($_POST) {
    ...
    if (isset($_POST['user'])) {
        $post['user_name'] = addslashes($_POST['user']);
    } else {
...
//Icone
$icon = '<svg class="w3-bar-item" width="85" height="85" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="w3-row-padding w3-content" style="max-width:700px">
            <div class="w3-container w3-margin-top w3-card-4">
                <div class="w3-container">
                    <p>Essa página lista os gestores e os avaliadores deste wikiconcurso. Ao gestor do concurso também são exibidas opções para habilitar ou desabilitar avaliadores.</p>
                </div>
            </div>
            <div class="w3-margin-top w3-card">
                <header style="filter: hue-rotate(60deg);" class='w3-container w3-<?=$contest['theme'];?>'><h1>Gestores</h1></header>
                <div class="w3-container">
                    <ul class="w3-ul">
            ...
            <div class="w3-margin-top w3-card">
                <header style="filter: hue-rotate(120deg);" class='w3-container w3-<?=$contest['theme'];?>'><h1>Avaliadores</h1></header>
                <div class="w3-container">
                    <ul class="w3-ul">
            ...
            <div class="w3-margin-top w3-card">
                <header style="filter: hue-rotate(180deg);" class='w3-container w3-<?=$contest['theme'];?>'><h1>Desabilitados</h1></header>
                <div class="w3-container">
                    <ul class="w3-ul">
