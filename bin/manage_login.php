...
<html lang="pt-br">
    ...
    <body>
        <header class="w3-deep-green w3-container">
            ...
            <button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-half w3-block w3-deep-green w3-large" style="filter: hue-rotate(180deg);">Login</button>
